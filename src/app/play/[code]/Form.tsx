...
const Form = ({
  ...
  return (
    <form
      ...
      className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:translate-x-0 lg:translate-y-0 lg:static  lg:w-1/3 lg:h-fit px-8 py-16  fade-in  bg-zinc-950 flex flex-col gap-4 justify-center items-center w-[min(90%)] h-[90%] rounded-2xl shadow-[0px_0px_10px_#fff,0px_0px_10px_20px_${COLORS[playerOnTurn]}]`}
    >
